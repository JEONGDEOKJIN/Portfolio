  ...
  return (
    <>
      ...
      >
        ...
        <ListOption  
            keywordToDB = 'roles_frontend'
            keywordToShow = 'FrontEnd ⛳'
            selectedFilterOptionArr = {selectedFilterOptionArr}
            handleFilterDropDownList = {() => handleFilterDropDownList("roles_frontend")}
        />
        
        <ListOption  
            keywordToDB = 'roles_backend'
            keywordToShow = 'BackEnd ⛳'
            selectedFilterOptionArr = {selectedFilterOptionArr}
            handleFilterDropDownList = {() => handleFilterDropDownList("roles_backend")}
        />
        
        <ListOption  
            keywordToDB = 'roles_aws'
            keywordToShow = 'AWS ⛳'
            selectedFilterOptionArr = {selectedFilterOptionArr}
            handleFilterDropDownList = {() => handleFilterDropDownList("roles_aws")}
        />
