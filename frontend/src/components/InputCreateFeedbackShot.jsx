  ...
  return (
    <>
      <div className="">
        ...
        <input
          className={`
          w-[300px] block p-2 my-[2px] min-h-[27px] text-[16px] text-[#33475b] border-[1px]  focus:border-[#52a8eccc] outline-0  h-[40px] px-[15px] rounded-[15px] max-w-[100%] bg-neutral-100
